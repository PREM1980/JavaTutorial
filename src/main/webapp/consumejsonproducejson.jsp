...
<body>
	...
	<div id="mainbody">
		...
		<div id="content">
			...
			<div id="maincontent">
				<h1>REST Service - Consume JSON/Produce JSON</h1>
			<br>
			<div class="description">
			In this example, we will build a service that will consume JSON and Produce JSON.
			</div>
			<br>
...
<xmp>
	...
	<artifactId>RESTFulConJSONProdJSON</artifactId>
	<packaging>war</packaging>
	<version>0.0.1-SNAPSHOT</version>
	<name>RESTFulConJSONProdJSON Maven Webapp</name>
