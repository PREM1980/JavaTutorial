...
<body>
	<div id="mainbody">
		...
		<div id="content">
			...
			<div id="maincontent">
				<br> <br><a href="jsequals.jsp">What is difference between double(==) and triple(===) in javascript</a>
				<br> <br><a href="jsnull.jsp">What is difference between undefined and null in javascript</a>
